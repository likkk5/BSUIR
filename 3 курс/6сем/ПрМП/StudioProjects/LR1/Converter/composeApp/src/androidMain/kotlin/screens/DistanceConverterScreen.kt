...
import common.DistanceUnit
import common.KeyboardFragment
import navigation.DistanceConverterComponent

@Composable
fun DistanceConverterScreen(component: DistanceConverterComponent) {
    var inputValue by remember { mutableStateOf("") }
    var fromUnit by remember { mutableStateOf(DistanceUnit.Meters) }
    var toUnit by remember { mutableStateOf(DistanceUnit.Yards) }
