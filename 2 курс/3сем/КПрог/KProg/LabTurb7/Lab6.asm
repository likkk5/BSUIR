...
.data
    ...
    errFileOpenRd   db      0dh,0ah,"File open (for read) - error, choose another one", 0Dh, 0Ah,'$'
    ...
    delmsg          db      0Dh, 0Ah,"File was successfully deleted", '$' 
    deleterrormsg   db      0Dh, 0Ah,"File wasn't successfully deleted", '$'
...
enter_line arg_string, filename_length   
mov si, filename_length
mov [arg_string+si],0
...
WHILE_:
    ...
    jmp  BREAK_          ; Jump to BREAK

FILE_READ_OK:
    ;test ax, ax         ; Test if AX is zero (end of file)
    ;jz   BREAK_          ; Jump to BREAK if zero
