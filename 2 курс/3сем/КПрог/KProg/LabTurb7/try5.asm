...
.data
    ...
    Array           dw      50 dup(?)
    CrLf            db      0Dh, 0Ah, '$'  
    firstfile       db "Lab6.exe", 0, '$'
    secondfile      db "TasmLab5.exe", 0, '$'  
    thirdfile       db "Lab1ITA.exe", 0, '$'   
...
; Read user's choice
    ...
    int 21h
    cmp al, 'y'
    je NP  ; Jump to NEW_PROG if the user enters 'y'
    jmp TUT
NP:
    jmp NEW_PROG
TUT:    
