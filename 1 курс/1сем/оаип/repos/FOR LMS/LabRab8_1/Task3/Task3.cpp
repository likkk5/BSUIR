...
void PrintEmployees(Employee* femployees, const int famountofem)
{
    ...
    for (i = 1; i <= famountofem; i++, femployees++)
    {
        printf("| %6d | %31s | %35s | %35s | %17s | %20d | %20.2f | %21.2f |\n",
            i, femployees->last_name, femployees->first_name, femployees->midle_name, femployees->personal_number, femployees->hours, femployees->hourly_rate, femployees->salary);
    }
    printf("------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n\n");
}
...
// сохранение изменений о сотруднике в файл
...
void PrintSearchEmployee(Employee* femployees, int foundEmployee)
{
    ...
    printf("| %6d | %31s | %35s | %35s | %17s | %20d | %20.2f | %21.2f |\n",
        foundEmployee + 1, femployees[foundEmployee].last_name, femployees[foundEmployee].first_name, femployees[foundEmployee].midle_name, femployees[foundEmployee].personal_number, femployees[foundEmployee].hours, femployees[foundEmployee].hourly_rate, femployees[foundEmployee].salary);
    printf("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n\n");
}
...
void CalculateSalaryEmployees(Employee* femployees, int* famountofem)
{
    ...
    do
    {
        ...
        while (true)
        {
            ...
            if (temp_str == "1")
            {
                ...
                amountofem = 0;
                employees = readWrite.readAll(amountofem);
                repeat1 = 1;
                break;
            }
            ...
            if (temp_str == "8")
            {
                if (repeat1 != 0)
                {
                    ...
                    readFileAmount = 0;
                    PrintEmployees(readWrite.readAll(readFileAmount), readFileAmount);
                }
                else
                {
