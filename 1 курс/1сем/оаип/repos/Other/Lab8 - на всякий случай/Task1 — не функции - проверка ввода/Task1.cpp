...
std::string InputString(int ii, int max)
{
    ...
    while (true)
    {
        ...
        if (temp_input.length() > MAX_LENGHT_STRING)
        {
            printf("Повторите ввод. Некорректное значение.\n");
            std::cin.clear();
        }
        else
        {
            ...
            {
                if ((temp_input[jj] < 65) || ((temp_input[jj] > 90) && (temp_input[jj] < 97)) || (temp_input[jj] > 122))
                {
                    kk++;
                }
            }
...
std::string InputTime(int ii, int max)
{
    ...
    while (true)
    {
        ...
        if (temp_input.length() > MAX_COUNT_TIME)
        {
            printf("Повторите ввод. Некорректное значение.\n");
            std::cin.clear();
        }
...
void FillTrains1(depo* ftrains, const int famountoftr)
{
    ...
    for (i = 1; i <= famountoftr; i++, ftrains++)
    {
        ...
        //как правильно вернуть значения в ftrains->departure, ftrains->destination, ftrains->departure_time
        /*char* symbols = nullptr;
        symbols = new char[MAX_LENGHT_STRING];
        
        symbols = InputString(1, MAX_LENGHT_STRING, symbols);
        for (j = 0;j < temp_str.length(); j++)
        {
            ftrains->departure[i] = symbols[i];
            printf("\n %c", ftrains->departure[i]);
        }
        //printf("\n %s", ftrains->departure);
    ...
    do
    {
        ...
        *famountoftr = *famountoftr + 1;
        ...
        while (true)
        {
            ...
            while (ftrains[i - 1].departure[jj] != '\0')
            {
                jj++;
            }
            ll = jj;
            ...
            else
            {
                ...
                for (jj = 0;jj < ll;jj++)
                {
                    if ((ftrains[i - 1].departure[jj] < 65) || ((ftrains[i - 1].departure[jj] > 90) && (ftrains[i - 1].departure[jj] < 97)) || (ftrains[i - 1].departure[jj] > 122))
                    {
                        kk++;
                    }
                }
        ...
        while (true)
        {
            ...
            while (ftrains[i - 1].destination[jj] != '\0')
            {
                jj++;
            }
            ll = jj;
            ...
            else
            {
                ...
                for (jj = 0;jj < ll;jj++)
                {
                    if ((ftrains[i - 1].destination[jj] < 65) || ((ftrains[i - 1].destination[jj] > 90) && (ftrains[i - 1].destination[jj] < 97)) || (ftrains[i - 1].destination[jj] > 122))
                    {
                        kk++;
                    }
                }
        ...
        while (true)
        {
            ...
            while (ftrains[i - 1].departure_time[jj] != '\0')
            {
                jj++;
            }
            ll = jj;
            ...
            else
            {
                ...
                if (ftrains[i - 1].departure_time[2] == ':')
                {
                    kk++;
                }
                ...
                for (jj = 0;jj < ll;jj++)
                {
                    if ((ftrains[i - 1].departure_time[jj] >= 48) && (ftrains[i - 1].departure_time[jj] <= 57) && (jj != 2))
                    {
                        kk++;
                    }
                }
                ...
                {
                    int hour = 0, min = 0;
                    hour = (ftrains[i - 1].departure_time[0] - 48) * 10 + (ftrains[i - 1].departure_time[1] - 48);
                    min = (ftrains[i - 1].departure_time[3] - 48) * 10 + (ftrains[i - 1].departure_time[4] - 48);
                    if ((hour >= 0) && (hour <= 23) && (min >= 0) && (min <= 59))
                    {
                        break;
                    }
...
void AddNewTrain(depo* ftrains, int* famountoftr)
{
    ...
    while (true)
    {
        ...
        while (ftrains[add].departure[jj] != '\0')
        {
            jj++;
        }
        ll = jj;
        ...
        else
        {
            ...
            for (jj = 0;jj < ll;jj++)
            {
                if ((ftrains[add].departure[jj] < 65) || ((ftrains[add].departure[jj] > 90) && (ftrains[add].departure[jj] < 97)) || (ftrains[add].departure[jj] > 122))
                {
                    kk++;
                }
            }
    ...
    while (true)
    {
        ...
        while (ftrains[add].destination[jj] != '\0')
        {
            jj++;
        }
        ll = jj;
        ...
        else
        {
            ...
            for (jj = 0;jj < ll;jj++)
            {
                if ((ftrains[add].destination[jj] < 65) || ((ftrains[add].destination[jj] > 90) && (ftrains[add].destination[jj] < 97)) || (ftrains[add].destination[jj] > 122))
                {
                    kk++;
                }
            }
    ...
    while (true)
    {
        ...
        while (ftrains[add].departure_time[jj] != '\0')
        {
            jj++;
        }
        ll = jj;
        ...
        else
        {
            ...
            if (ftrains[add].departure_time[2] == ':')
            {
                kk++;
            }
            ...
            for (jj = 0;jj < ll;jj++)
            {
                if ((ftrains[add].departure_time[jj] >= 48) && (ftrains[add].departure_time[jj] <= 57) && (jj != 2))
                {
                    kk++;
                }
            }
            ...
            {
                int hour = 0, min = 0;
                hour = (ftrains[add].departure_time[0] - 48) * 10 + (ftrains[add].departure_time[1] - 48);
                min = (ftrains[add].departure_time[3] - 48) * 10 + (ftrains[add].departure_time[4] - 48);
                if ((hour >= 0) && (hour <= 23) && (min >= 0) && (min <= 59))
                {
                    break;
                }
...
//ftrains[editIndex].amount = InputNumber(2, MAX_NUMBER_TRAIN);
    ...
    while (true)
    {
        ...
        while (ftrains[editIndex].departure[jj] != '\0')
        {
            jj++;
        }
        ll = jj;
        ...
        else
        {
            ...
            for (jj = 0;jj < ll;jj++)
            {
                if ((ftrains[editIndex].departure[jj] < 65) || ((ftrains[editIndex].departure[jj] > 90) && (ftrains[editIndex].departure[jj] < 97)) || (ftrains[editIndex].departure[jj] > 122))
                {
                    kk++;
                }
            }
    ...
    while (true)
    {
        ...
        while (ftrains[editIndex].destination[jj] != '\0')
        {
            jj++;
        }
        ll = jj;
        ...
        else
        {
            ...
            for (jj = 0;jj < ll;jj++)
            {
                if ((ftrains[editIndex].destination[jj] < 65) || ((ftrains[editIndex].destination[jj] > 90) && (ftrains[editIndex].destination[jj] < 97)) || (ftrains[editIndex].destination[jj] > 122))
                {
                    kk++;
                }
            }
    ...
    while (true)
    {
        ...
        while (ftrains[editIndex].departure_time[jj] != '\0')
        {
            jj++;
        }
        ll = jj;
        ...
        else
        {
            ...
            if (ftrains[editIndex].departure_time[2] == ':')
            {
                kk++;
            }
            ...
            for (jj = 0;jj < ll;jj++)
            {
                if ((ftrains[editIndex].departure_time[jj] >= 48) && (ftrains[editIndex].departure_time[jj] <= 57) && (jj != 2))
                {
                    kk++;
                }
            }
            ...
            {
                int hour = 0, min = 0;
                hour = (ftrains[editIndex].departure_time[0] - 48) * 10 + (ftrains[editIndex].departure_time[1] - 48);
                min = (ftrains[editIndex].departure_time[3] - 48) * 10 + (ftrains[editIndex].departure_time[4] - 48);
                if ((hour >= 0) && (hour <= 23) && (min >= 0) && (min <= 59))
                {
                    break;
                }
